...
def train_lm(cfg: DictConfig) -> None:
    ...
    if "tokenizer" in cfg.trainer:
        cfg.trainer.tokenizer = hydra.utils.instantiate(cfg.trainer.tokenizer)
        print(cfg.trainer.tokenizer)
    cfg.trainer = hydra.utils.instantiate(
